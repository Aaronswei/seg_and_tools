...
get_branch_logits = deeplab_model.get_branch_logits
get_extra_layer_scopes = deeplab_model.get_extra_layer_scopes
multi_scale_logits_v2 = deeplab_model.multi_scale_logits
refine_by_decoder = deeplab_model.refine_by_decoder
scale_dimension = deeplab_model.scale_dimension
split_separable_conv2d = deeplab_model.split_separable_conv2d

MERGED_LOGITS_SCOPE = deeplab_model.MERGED_LOGITS_SCOPE
IMAGE_POOLING_SCOPE = deeplab_model.IMAGE_POOLING_SCOPE
ASPP_SCOPE = deeplab_model.ASPP_SCOPE
CONCAT_PROJECTION_SCOPE = deeplab_model.CONCAT_PROJECTION_SCOPE
