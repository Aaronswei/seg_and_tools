...
import utils.feature_extractor  as feature_extractor

from constant import _PROB_OF_FLIP

get_random_scale = preprocess_utils.get_random_scale
randomly_scale_image_and_label = (preprocess_utils.randomly_scale_image_and_label)
